namespace RepoLayer
{
    ...
    public class RLayer : IRLayer
    {
        ...
        {
            string s1 = "Gulati@12345";
            string key = "BwWtACksJS";
            //var keyNew = SaltGenerator.GeneratePassword(10);
            string epass = SaltGenerator.EncodePassword(s1,key).ToString();
            string dpass = SaltGenerator.Base64Decode("NzdheWRtZCtLV090dkNuZ1RjOVBoakZxUjVtdmN3b3hBZ3NldVFyQkVEZz0=");
